...
public class CloudBaseTabAdapter<T> extends BaseQuickAdapter<T, BaseViewHolder> {

    public CloudBaseTabAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
        super(layoutResId, data);
    }

    public CloudBaseTabAdapter(@Nullable List<T> data) {
        super(data);
    }

    public CloudBaseTabAdapter(@LayoutRes int layoutResId) {
        super(layoutResId);
    }
